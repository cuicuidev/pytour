...
class Coordinates:
    ...
    def get_distance(self, other: Type["Coordinates"], type: str = "haversine") -> float:
        if type == "haversine":
    ...
    def _get_euclidian(self, other: Type["Coordinates"]) -> float:
        pass

    def _get_manhattan(self, other: Type["Coordinates"]) -> float:
        pass
        
    def _get_haversine(self, other: Type["Coordinates"]) -> float:
        R = 6371.0
